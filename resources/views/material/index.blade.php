...
<div class="modal fade" id="modalCreate" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" >
            <form role="form" method="POST" action="{{ url('material') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <!-- <div class="form-group col-md-2 mr-2">
                            ...
                            <div>
                                <label class="radio-inline">
                                    <input type="radio" id="radioOption1" name="satuan" value="cm"> cm
                                </label>

                                <label class="radio-inline">
                                    <input type="radio" id="radioOption2" name="satuan" value="kg"> kg
                                </label>
