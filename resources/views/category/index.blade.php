...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <a href="#modalCreate" data-toggle='modal' class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah Kategori</a><br><br>
                        ...
                        <table class="table table-bordered" style="text-align: center;" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$d->nama}}</td>
                                    <td>
                                        <form id="delete-form-{{ $d->id }}" action="{{ route('category.destroy', $d->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
